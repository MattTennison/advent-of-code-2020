...
RSpec.describe ShipNavigationFactory do
  ...
  describe 'ShipNavigationSystem' do
    where(:case_name, :instruction_str_arr, :expected_finishing_position) do
      [
        ['provided example', %w[F10 N3 F7 R90 F11], Vector[214, -72]],
        ['with a left turn', %w[F10 N3 F7 L90 F11], Vector[126, 148]],
        ['with a 180 degree turn', %w[E3 N4 R180 F5], Vector[-65, -25]],
        ['with a 180 degree left turn', %w[E3 N4 L180 F5], Vector[-65, -25]],
        ['with a 270 degree turn', %w[E3 N4 R270 F5], Vector[-25, 65]],
        ['with a 0 degree turn', %w[F10 N3 F7 R90 R0 F11], Vector[214, -72]]
      ]
    end
